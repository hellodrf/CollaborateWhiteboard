...
import whiteboard.WhiteboardIndexServer;
import whiteboard.managers.ClientManager;
import whiteboard.managers.IOThread;
import whiteboard.managers.PeerManager;
...
public class WhiteboardApp {
	...
	public void connectToIndexServer(String host, int port)
		...
		serverClientManager.on(PeerManager.peerStarted, (args) -> {
            ...
            serverEndpoint.on(WhiteboardIndexServer.sharingBoard, (args1 -> {
            ...
            })).on(WhiteboardIndexServer.unsharingBoard, (args1) -> {
    ...
    private void setShareToServer(Whiteboard whiteboard, Boolean share) {
		if (serverEndpoint != null) {
			serverEndpoint.emit(share ? WhiteboardIndexServer.shareBoard : WhiteboardIndexServer.unshareBoard,
					whiteboard.getName());
