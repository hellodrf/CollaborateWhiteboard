 ...
 * @see {@link whiteboard.Protocol}
 * @see {@link whiteboard.protocols.IRequestReplyProtocol}
 * @see {@link whiteboard.protocols.session.SessionStartRequest}
 * @see {@link whiteboard.protocols.session.SessionStartReply}
 * @see {@link whiteboard.protocols.session.SessionStopRequest}
 * @see {@link whiteboard.protocols.session.SessionStopReply}
 * @author aaron
 *
 */
